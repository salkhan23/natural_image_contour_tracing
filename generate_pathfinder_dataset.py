...
#
# This is a binary classification task where the model has to determine if Markers
# are connected via a smooth edge.
#
...
BIPED_DATASET_DIR = '/home/salman/workspace/pytorch/contour_integration_pytorch/data/BIPED/edges'
